...
- **Temporary debug painter:** `InkPaintDebugger` on scene GO `DebugTools` (hold Attack, center-screen ray) — step-3 scaffolding, DELETE when step 4's real weapon lands.
