...
3.5 ✅ **手感回饋修正**(2026-09-02,使用者實玩回饋四項):
   - 準星:相機取景抬高 1.1m(角色壓到畫面下半)+ `AimReticle` 動態準星 = 彈道預測落點(拋物線武器不能用畫面中心;原本準星指 18.8m 而彈落 5.8m)。驗證誤差 0.56m。
   - 彈道:沿途滴墨(間距 0.6m/半徑 0.35m,須 < 2×半徑才連續)+ 射程調成 28/-14。塗地效率 delta 374→1653。
