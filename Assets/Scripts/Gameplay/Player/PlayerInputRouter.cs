...
namespace SplatoonC.Gameplay.Player
{
    ...
    public sealed class PlayerInputRouter : MonoBehaviour, ILocomotionIntentSource
    {
        private ILocomotionIntentSource _overrideSource;
        ...
        public void SetOverrideSource(ILocomotionIntentSource source)
        {
